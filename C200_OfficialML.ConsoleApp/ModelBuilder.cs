...
namespace C200_OfficialML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\20007073\Desktop\RP\Y2 Sem 2\C200 Special Project\facebook_comments.csv";
        private static string MODEL_FILEPATH = @"C:\Users\20007073\AppData\Local\Temp\MLVSTools\C200_OfficialML\C200_OfficialML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Label", "Label")
                                      .Append(mlContext.Transforms.Text.FeaturizeText("Comments_tf", "Comments"))
                                      .Append(mlContext.Transforms.CopyColumns("Features", "Comments_tf"))
